    ...
    <div className="flex flex-col items-center gap-32">
      <div className="flex flex-col items-center w-full gap-12">
        <section className="max-w-4xl mx-auto">
          <h1 className="text-2xl md:text-3xl">TEAM</h1>
        </section>

        {/* 3 Bilder mit Abstand nebeneinander, nicht versetzte Höhen. */}
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-12 w-full max-w-6xl">
        ...
        >
          <div className="w-full aspect-[3/4] shadow-[0_8px_30px_rgb(94,116,97,0.2)]">
            <img 
          ...
          <div className="flex flex-col items-center text-sm leading-relaxed gap-2 text-center">
            <h3 className="text-xl mb-2 font-medium">FLO</h3>
        ...
        >
          ...
          <div className="flex flex-col items-center text-sm leading-relaxed gap-2 text-center">
            <h3 className="text-xl mb-2 font-medium">KRISPIN</h3>
        ...
        >
          ...
          <div className="flex flex-col items-center text-sm leading-relaxed gap-2 text-center">
            <h3 className="text-xl mb-2 font-medium">PASCAL</h3>
